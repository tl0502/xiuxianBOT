    ...
    questions: [
      {
        ...
        options: [
          { text: '仔细研究禁制，寻找破解之法', value: { focus: 5, stability: 3 } },
          { text: '直接强行闯入，速战速决', value: { courage: 4, impatience: 3, determination: 2 } },
          { text: '先退后观察，等待时机', value: { stability: 5, focus: 2 } },
          { text: '设法引诱他人先行试探', value: { manipulation: 5, greed: 2 } }
        ]
      },
      {
        id: 'q2',
        ...
        options: [
          { text: '只取朴实那件，光芒太盛必有蹊跷', value: { focus: 4, stability: 4, honesty: 2 } },
          { text: '两件都要，管他什么气息', value: { greed: 5, impatience: 3 } },
          { text: '都不取，直觉告诉你这是陷阱', value: { stability: 5, focus: 2 } },
          { text: '先用法诀检验两件宝物', value: { focus: 5, stability: 3 } }
        ]
      },
      {
        id: 'q3',
    ...
    questions: [
      {
        ...
        options: [
          { text: '立即购买，这是难得的机会', value: { impatience: 4, greed: 3 } },
          { text: '仔细检查秘籍真伪', value: { focus: 5, stability: 3 } },
          { text: '询问秘籍来源', value: { focus: 4, honesty: 2 } },
          { text: '直接离开，便宜没好货', value: { stability: 4, focus: 2 } }
        ]
      },
      {
        id: 'q2',
        ...
        options: [
          { text: '更加警惕，这像是在下套', value: { stability: 5, focus: 4 } },
          { text: '心动不已，立即成交', value: { greed: 5, impatience: 4 } },
          { text: '假装离开，看他反应', value: { manipulation: 4, focus: 3 } },
          { text: '要求试用后再决定', value: { focus: 4, stability: 2 } }
        ]
      },
      {
        id: 'q3',
