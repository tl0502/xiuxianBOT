    ...
    questions: [
      {
        ...
        options: [
          { text: '毫不犹豫地帮助，朋友比什么都重要', value: { kindness: 5, courage: 5, honesty: 2 } },
          { text: '提供有限帮助，但不直接对抗', value: { kindness: 3, stability: 3, manipulation: 2 } },
          { text: '劝说他自首或逃走，自己不参与', value: { stability: 4, focus: 2 } },
          { text: '拒绝帮助，甚至考虑出卖换取好处', value: { greed: 5, manipulation: 5, kindness: -3 } }
        ]
      },
      {
        id: 'q2',
        ...
        options: [
          { text: '调查真相，为他洗清冤屈', value: { honesty: 5, courage: 5, kindness: 3 } },
          { text: '告诉他真相，由他自己决定', value: { honesty: 4, kindness: 3 } },
          { text: '保持沉默，事不关己', value: { stability: 3, kindness: -2 } },
          { text: '这改变不了我的决定', value: { determination: 4, stability: 2 } }
        ]
      },
      {
        id: 'q3',
    ...
    questions: [
      {
        ...
        options: [
          { text: '立即放弃突破，回家救援', value: { kindness: 5, courage: 5, determination: 2 } },
          { text: '加速突破，然后回去（可能来不及）', value: { determination: 4, focus: 3, impatience: 2 } },
          { text: '完成突破再回去，实力更强才能帮上忙', value: { focus: 4, determination: 3, greed: 2 } },
          { text: '不回去，避免自己也陷入险境', value: { greed: 4, stability: 3, kindness: -3 } }
        ]
      },
      {
        id: 'q2',
        ...
        options: [
          { text: '无论如何都要救家族，这是血脉责任', value: { kindness: 5, courage: 4, honesty: 2 } },
          { text: '救人但要求族长认错改过', value: { honesty: 5, determination: 4, kindness: 2 } },
          { text: '只救无辜族人，不管族长', value: { kindness: 4, focus: 3, determination: 2 } },
          { text: '这是他自找的，让他自己承担', value: { determination: 3, stability: 2, kindness: -2 } }
        ]
      },
      {
        id: 'q3',
