    ...
    questions: [
      {
        ...
        options: [
          { text: '左边暗道，隐蔽安全', value: { stability: 4, focus: 3 } },
          { text: '中间大道，正面突破', value: { courage: 5, determination: 4 } },
          { text: '右边小径，阵法或藏机缘', value: { courage: 4, greed: 3 } },
          { text: '先探查再决定', value: { focus: 5, stability: 4 } }
        ]
      },
      {
        id: 'q2',
        ...
        options: [
          { text: '救人为先，宝物可以不要', value: { kindness: 5, courage: 4, honesty: 2 } },
          { text: '先拿宝箱，再看能否救人', value: { greed: 4, manipulation: 2 } },
          { text: '询问修士宝箱里是什么', value: { manipulation: 3, greed: 3, focus: 1 } },
          { text: '尝试同时破解两处机关', value: { determination: 5, courage: 3, focus: 3 } }
        ]
      },
      {
        id: 'q3',
    ...
    questions: [
      {
        ...
        options: [
          { text: '危险高收益，富贵险中求', value: { courage: 5, determination: 4, greed: 3 } },
          { text: '安全中收益，稳中求进', value: { stability: 5, focus: 3 } },
          { text: '未知处，也许有意外惊喜', value: { courage: 4, focus: 3 } },
          { text: '快速扫荡，三处都去看看', value: { greed: 5, impatience: 4 } }
        ]
      },
      {
        id: 'q2',
        ...
        options: [
          { text: '同意合作，人多力量大', value: { kindness: 4, stability: 3 } },
          { text: '婉拒，独行更自在', value: { determination: 4, focus: 2 } },
          { text: '假意合作，暗中警惕', value: { manipulation: 4, stability: 3 } },
          { text: '先下手为强，消灭竞争者', value: { greed: 5, manipulation: 4, kindness: -3 } }
        ]
      },
      {
        id: 'q3',
