    ...
    questions: [
      {
        ...
        options: [
          { text: '修炼为先，唯有强大才能救更多人', value: { determination: 4, focus: 3, greed: 2 } },
          { text: '救人为先，道心不可失', value: { kindness: 5, courage: 4, honesty: 2 } },
          { text: '视情况而定，没有绝对的选择', value: { stability: 4, focus: 3 } },
          { text: '寻求两全之法，不做非此即彼的选择', value: { focus: 5, determination: 3 } }
        ]
      },
      {
        id: 'q2',
        ...
        options: [
          { text: '直面内心，剖析动摇之因', value: { honesty: 5, focus: 5 } },
          { text: '坚定信念，不予理会', value: { determination: 5, stability: 3 } },
          { text: '寻求师长指点', value: { honesty: 4, kindness: 2 } },
          { text: '入世历练，在红尘中磨砺', value: { courage: 4, determination: 3 } }
        ]
      },
      {
        id: 'q3',
    ...
    questions: [
      {
        ...
        options: [
          { text: '顺势而为，不强求', value: { stability: 5, focus: 2 } },
          { text: '生死循环，皆是自然', value: { stability: 4, honesty: 3 } },
          { text: '落叶归根，饮水思源', value: { kindness: 4, honesty: 3 } },
          { text: '只是落叶，何必多想', value: { stability: 3, focus: 1 } }
        ]
      },
      {
        id: 'q2',
        ...
        options: [
          { text: '柔能克刚，水滴石穿', value: { determination: 4, stability: 4 } },
          { text: '随形就势，灵活变通', value: { stability: 4, focus: 3 } },
          { text: '百川归海，殊途同归', value: { stability: 4, honesty: 2 } },
          { text: '逝者如斯，要珍惜时间', value: { focus: 3, impatience: 2 } }
        ]
      },
      {
        id: 'q3',
